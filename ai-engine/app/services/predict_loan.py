...
def predict_loan(data: dict) -> dict:
    """
    Input keys (all numeric after encoding):
      age, monthly_income, loan_amount, duration_months,
      existing_debt, num_dependents, employment_type,
      education, credit_history, collateral
