...
const translations = {
  en: {
    ...
    'landing.subtitle': 'A full digital banking experience with AI tips, payments, savings and better loans.',
    'landing.poweredBy': 'Made with AI',
    'landing.openAccount': 'Open Account',
    'landing.goToDashboard': 'Go to Dashboard',
    'landing.whyChoose': 'Why Choose AI Smart Banking?',
    'landing.whyChooseSub': 'Try the future of banking with our smart features',
    'landing.smartAccounts': 'Smart Accounts',
    'landing.smartAccountsDesc': 'Manage your accounts with clear view and AI advice.',
    'landing.instantPayments': 'Instant Payments',
    'landing.instantPaymentsDesc': 'Fast transfers, mobile money, and planned payments from one simple dashboard.',
    'landing.aiInsights': 'AI Tips',
    'landing.aiInsightsDesc': 'Get smart spending advice and personal money alerts that learn from you.',
    'landing.premiumFeatures': '💎 Premium Features',
    'landing.premiumDesc': 'Special benefits for premium members including fast support and detailed reports.',
    'landing.prioritySupport': 'Fast Support',
    'landing.advancedAnalytics': 'Detailed Reports',
    'landing.customReports': 'Custom Reports',
    'landing.trustedTitle': '❤️ Trusted by Thousands',
    'landing.trustedSub': 'Join thousands of happy customers who trust us with their money.',
    'landing.statsUsers': 'Users',
    'landing.statsRating': 'Rating',
    'landing.statsUptime': 'Uptime',
    'landing.quickStartTitle': '🚀 Quick Start',
    'landing.quickStartDesc': 'Get started in minutes with our simple sign-up process and easy-to-use interface.',
    'landing.quickStartBtn': 'Start Now',
    'landing.aiBenefits': '🤖 AI-powered benefits',
    'landing.aiBenefitsDesc': 'Use AI to find better ways to save, protect your money, and make smarter choices every time.',
    'landing.realTimeAlerts': 'Real-time alerts',
    'landing.realTimeAlertsDesc': 'Know about unusual activity and payment due dates right away.',
    'landing.smarterBudgeting': 'Smarter budgeting',
    'landing.smarterBudgetingDesc': 'See how your spending affects your goals right away.',
    'landing.loanPrediction': 'Loan prediction',
    'landing.loanPredictionDesc': 'See how much you can borrow before you apply.',
    'landing.goalProgress': 'Goal progress',
    'landing.goalProgressDesc': 'Keep your savings targets in view with progress tracking.',
    'landing.financialInsight': '💡 Money Tip',
    'landing.financialInsightSub': 'A quick look at your spending with AI advice.',
    ...
    'landing.financialOverview': '💳 Money Overview',
    'landing.accountBalance': 'Account balance',
    'landing.aiScore': 'AI score',
    'landing.aiScoreHealth': 'money health',
    ...
    'dash.welcomeSub': 'A full digital banking experience with AI tips, payments, savings, and better loans.',
    ...
    'dash.fraudAlert': 'Scam Alert Summary',
    'dash.alerts': 'Alerts',
    'dash.critical': 'Critical',
    'dash.bestInvest': 'Best Place to Invest',
    ...
    'dash.aiIndicators': 'AI-powered measures',
    'dash.gdpGrowth': 'GDP Growth',
    'dash.inflation': 'Inflation',
    'dash.sentiment': 'Sentiment',
    'dash.spendingIntel': 'Spending Analysis',
    'dash.totalVol': 'Total Payment Activity',
    'dash.viewAllInsights': 'See all AI tips',
    'dash.investComing': 'Investment feature coming soon!',
    'dash.qrComing': 'QR Payment feature coming soon!',
    'dash.noTx': 'No activity yet. Make your first deposit or transfer to get started.',
    'dash.noInsights': 'No AI tips yet. Start using your account to get personal advice.',
    ...
    'card.analyzeSpending': 'Check Spending',
    'card.financialHealth': 'Money Health',
    'card.loanEligibility': 'Can You Get a Loan?',
    'card.checkEligibility': 'Check Now',
    ...
    'card.aiHighlights': 'AI Top Tips',
    
    // Features
    'feature.aiPowered': 'AI-Powered Banking',
    'feature.aiDescription': 'Get personal money tips powered by smart AI',
    'feature.smartPayments': 'Smart Payments',
    'feature.paymentsDescription': 'Fast, instant payments with QR codes and mobile money',
    'feature.savingsGoals': 'Savings Goals',
    'feature.savingsDescription': 'Set and track your savings goals with smart suggestions',
    
    // Premium Features
    'premium.title': 'Premium Features',
    'premium.advanced': 'Detailed Reports',
    'premium.advancedDesc': 'In-depth look at how you spend',
    'premium.priority': 'Fast Support',
    'premium.priorityDesc': '24/7 help whenever you need it',
    'premium.custom': 'Loans Made for You',
    'premium.customDesc': 'Loans that fit your needs with better rates',
    
    // Stats
    'stats.users': 'Active Users',
    'stats.transactions': 'Payments',
    'stats.satisfaction': 'Happiness Rate',
    'stats.countries': 'Countries',
    
    // Quick Start
    'quickStart.title': 'Quick Start',
    'quickStart.description': 'Get started with AI Smart Banking in just a few steps',
    'quickStart.start': 'Start Now',
    
    // Footer
    'footer.company': 'AI Smart Banking',
    'footer.tagline': 'Banking Reimagined',
    'footer.description': 'Try the future of banking with our AI-powered money tool. Smart, safe, and made for you.',
    ...
    // Loan Application
    'loanApplication.title': 'Smart Loan Application',
    'loanApplication.subtitle': 'Fill in the form and send for AI loan approval.',
    'loanApplication.loading': 'Loading your profile information...',
    'loanApplication.profileComplete': 'Profile Complete - Can Get Loan',
    'loanApplication.profileIncomplete': 'Profile Not Complete - Needs Work',
    'loanApplication.profileCompleteDesc': 'Your profile is complete. You can apply for loans with AI approval.',
    'loanApplication.profileIncompleteDesc': 'Please finish your profile details before applying for a loan.',
    'loanApplication.completeProfile': 'Finish Profile Now',
    'loanApplication.aiPrediction': 'AI Loan Estimate',
    'loanApplication.aiPredictionDesc': 'Get personal loan estimates based on your profile',
    'loanApplication.buildCredit': 'Start using your account to build your credit for better loan chances.',
    'loanApplication.requestedAmount': 'Requested Amount (RWF)',
    'loanApplication.maxEligible': 'Max you can get',
    ...
    'loanApplication.existingDebt': 'Current Monthly Debt (RWF)',
    'loanApplication.purpose': 'Loan Purpose',
    'loanApplication.completeProfileFirst': 'Complete Profile First',
    'loanApplication.submit': 'Send for AI Approval',
    ...
    'loanApplication.deductionInfo': 'Set up auto-payment to repay your loan without thinking',
    'loanStatus.progress': 'How You Are Paying Back',
    'loanStatus.daysRemaining': 'Days left to finish paying',
    ...
    'loanStatus.extensionApproved': 'More Time Approved!',
    'loanStatus.extensionDenied': 'More Time Denied',
    'loanStatus.noLoans': 'No loan applications yet',
    'schedules.title': 'Payment Schedules',
    'schedules.subtitle': 'Set up repeat payments with AI-powered auto-pay',
    ...
    'savings.autoDeductionInfo': 'Set up auto-save to save money from your balance automatically',
    ...
    'mobile.qrPaymentsDesc': 'Pay at any shop by scanning a QR code. Fast, safe, and no touching needed.',
    'mobile.mobileDeposits': 'Mobile Deposits',
    'mobile.mobileDepositsDesc': 'Add cash through mobile money agents across Rwanda. Instant credit to your account.',
    'mobile.biometric': 'Fingerprint & Face Security',
    'mobile.biometricDesc': 'Keep your account safe with fingerprint and face recognition. Your phone is your key.',
    ...
    'mobile.notifyTitle': 'Get Updates',
    'mobile.notifyDesc': 'Be the first to know when our mobile app comes out. Sign up for early access.',

    // Insurance
    'insurance.heroTitle': 'Smart Protection for Life\'s Surprises',
    'insurance.heroDesc': 'AI insurance that changes with your lifestyle. Fair prices, instant claims, and cover made for you.',
    'insurance.riskBased': 'AI Pricing Based on Your Risk',
    'insurance.riskBasedDesc': 'Regular insurance uses one-size-fits-all models. We use AI to check your personal risk and give you fair pricing. Low-risk customers pay less.',
    'insurance.howItWorks': 'How It Works:',
    'insurance.step1': 'Give basic health and lifestyle info',
    'insurance.step2': 'AI checks your risk profile using smart systems',
    'insurance.step3': 'Get a personal insurance price right away',
    'insurance.step4': 'Get ongoing discounts for healthy living',
    'insurance.stayUpdated': 'Insurance products are being improved. Sign up to know when new features are ready.',
